...
;
    ...
    void saveSelection()
    {
        ...
        for (int i = 0; i <6; i++)
        {
            ...
            ed.putBoolean(str, toggleButton.isChecked()); //В метод putString указывается наименование переменной – это константа SAVED_TEXT, и значение – содержимое поля etText
    ...
    void loadSelection()
    {
        ...
        for (int i = 0; i <6; i++)
        {
            ...
            toggleButton = listTB.get(i);
            String str = Integer.toString(i);
            boolean savedSelection1 = sPref.getBoolean(str, false);
